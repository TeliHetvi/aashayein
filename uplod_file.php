...
<div class="bg-img">
	<div class="contents"> 
		<h1 style="color:white; text-align:center; font-size:400%;"> Share Something</h1>
		<center>
        <p style="color:#ffdab9; text-align:center; font-size:200%;"><b></b>
		<form action="aashayein.php" method="post" enctype="multipart/form-data">
		<label style="color:#ffdab9; text-align:center; font-size:150%;" for="fileToUpload"><b>Select your Image</b></label>
		<input style="color:#ffdab9; text-align:center; font-size:100%;" type="file" name="fileToUpload" id="fileToUpload"></br>
		<label style="color:#ffdab9; text-align:center; font-size:150%;" for="Uploadtext"><b>Write about Image</b></label>
		<input type="text" name="Uploadtext" id="Uploadtext"></br>
